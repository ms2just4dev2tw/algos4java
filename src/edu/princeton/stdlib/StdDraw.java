 ...
 * types of methods in standard drawing鈥攎ethods that draw geometric shapes and
 ...
 * <p>
 * <b>Saving to a file.</b> You save your image to a file using the <em>File 鈫�
 ...
 * call a drawing method鈥攕uch as {@code point()} or {@code line()}鈥攖he results
 ...
 * segment from (0.5, 鈥�10^308) to (0.5, 10^308) may not be visible even in the
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	 ...
	 * ..., (<em>x</em><sub><em>n</em>鈥�1</sub>,
	 * <em>y</em><sub><em>n</em>鈥�1</sub>).
	 *
