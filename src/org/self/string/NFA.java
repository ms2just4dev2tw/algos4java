...
/******************************************************************************
 * Compilation: javac NFA.java Execution: java NFA regexp text Dependencies:
 * Stack.java Bag.java Digraph.java DirectedDFS.java
 *
 ...
 *
 * Remarks ----------- The following features are not supported: - The +
 * operator - Multiway or - Metacharacters in the text - Character classes.
 *
 ******************************************************************************/
